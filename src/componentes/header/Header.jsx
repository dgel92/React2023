...
function Header(){
    return(
        <header >
	        <a href="/index.html" className="brand"><h1>BIDET ESTUDIO</h1></a>
				...
				<ul className="menu">
					<li className="active"><a href="/index.html">Mujer</a></li>
					<ul>
						<li><a href="/pages/personal-work.html">Personal Work</a></li>
						<li><a href="/pages/comercial-work.html">Comercial Work</a></li>
						<li><a href="/pages/about-us.html">About us</a></li>
					</ul>
				</ul>
				<ul className="menu">
					<li className="active"><a href="/index.html">Hombre</a></li>
					<ul>
						<li><a href="/pages/personal-work.html">Personal Work</a></li>
						<li><a href="/pages/comercial-work.html">Comercial Work</a></li>
						<li><a href="/pages/about-us.html">About us</a></li>
